...
class MNISTDataset(Dataset):
    def __init__(self, split='train'):
        ...
        fpath = "/Users/guangzhu/Desktop/ETHz/CV/assignments/code/mnist-classifier/data"
        data_path = os.path.join(fpath, f'{split}-images-idx3-ubyte.gz')
        labels_path = os.path.join(fpath, f'{split}-labels-idx1-ubyte.gz')
...
def normalize(sample):
    new_sample = sample * 2.0 / 255.0 - 1.0
    return new_sample
